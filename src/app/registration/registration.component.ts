...
export class RegistrationComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.reg_form = this.fb.group({
      ...
      // 'confirmEmail': new FormControl('', [ Validators.email, onConfirmEmailGiven]),
      /*'passwords': this.fb.group({
        'password': new FormControl('', [Validators.required, Validators.minLength(6), this.onPasswordGiven,

        Validators.pattern('^[a-zA-Z0-9@\#\$\&\* ]*$')], ),
        'confirmPassword': new FormControl('', [Validators.required, Validators.minLength(6), onConfirmPasswordGiven,
        Validators.pattern('^[a-zA-Z0-9@\#\$\&\* ]*$')])
