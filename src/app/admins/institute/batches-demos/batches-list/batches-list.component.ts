...
export class BatchesListComponent implements OnInit, AfterViewInit {
  ...
  displayedColumns = ['sno', 'batch_name', 'session_name', 'course_name', 'faculty','startson', 'demo_from_date',
    'demo_to_date', 'timings',  'action'];
  ...
  onEdit(i, row) {
    // alert('edit');
    this.routerobj.navigate(['../edit/' + row.bid],{ relativeTo: this.route});
  }
}
